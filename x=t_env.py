"""
Построение графика зависимости пареметров газа при вариации температуры окружающей среды
"""
...
# График зависимости средней температуры газа от т-ры окружающей среды
...
# График зависимости конечной температуры газа от температуры окружающей среды
graph_ind += 1
...
# График зависимости конечного давлениея газа от температуры окружающей среды
graph_ind += 1
...
# График зависимости разности давлениея газа от температуры окружающей среды
graph_ind += 1
...
# График зависимости числа Рейнольдса от температуры окружающей среды
graph_ind += 1
...
# График зависимости коэффициента сопротивления по длине от температуры окружающей среды
graph_ind += 1
...
# График зависимости коэффициента коэффициента кинематической вязкости от температуры окружающей среды
graph_ind += 1
...
# График зависимости средней скорости газового потока от температуры окружающей среды
graph_ind += 1
...
# figure(figsize=())
plt.savefig('variation_of_environment_temperature.jpg', dpi=700)
plt.show()
exit()
